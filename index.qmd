...
And there are also... unusual datasets[@cr-unusual-tidytuesday]
...
The [TudyTuesday](https://github.com/rfordatascience/tidytuesday) project isn't just a great place for you to find your favourite data story.
<br>
<br>
It's also an opportunity for you to flex your storytelling capabilities!
...
::::: {style="--cr-narrative-font-size:var(--size-normal);--cr-narrative-font-family:Karla;"}
...
This *scrollytelling* article was written by [Charlotte Hadley](https://visibledata.co.uk/) as an entry in the 2024 Closeread competition - the code is on GitHubXXXX.

You can find @charliejhadley on [BlueSky](https://bsky.app/profile/charliejhadley.bsky.social) and [LinkedIn](https://www.linkedin.com/in/charliejhadley/), if you've been inspired to find a favourite data story please let her know with **#favedatastory**.

<hr/>

[Closeread](https://closeread.dev/) is a scrollytelling Quarto format. 

Not heard of Quarto?! It's incredible. Use R, Python or Julia to build rich HTML, PDF or even Microsoft Office formatted reports - learn more at [quarto.org](https://quarto.org).
